...
public final class CommandRunner {
    ...
    public static ObjectNode select(final CommandInput commandInput) {
        ...
        String message;
        try {
            message = ((NormalUser) user).select(commandInput.getItemNumber());
        } catch (UserOfflineException e) {
            message = user.getUsername() + " is offline.";
        }
    ...
    public static ObjectNode playPause(final CommandInput commandInput) {
        ...
        String message;
        try {
            message = ((NormalUser) user).playPause();
        } catch (UserOfflineException e) {
            message = user.getUsername() + " is offline.";
        }
    ...
    public static ObjectNode shuffle(final CommandInput commandInput) {
        ...
        String message;
        try {
            message = ((NormalUser) user).shuffle(seed);
        } catch (UserOfflineException e) {
            message = user.getUsername() + " is offline.";
        }
    ...
    public static ObjectNode forward(final CommandInput commandInput) {
        ...
        String message;
        try {
            message = ((NormalUser) user).forward();
        } catch (UserOfflineException e) {
            message = user.getUsername() + " is offline.";
        }
    ...
    public static ObjectNode backward(final CommandInput commandInput) {
        ...
        String message;
        try {
            message = ((NormalUser) user).backward();
        } catch (UserOfflineException e) {
            message = user.getUsername() + " is offline.";
        }
    ...
    public static ObjectNode createPlaylist(final CommandInput commandInput) {
        ...
        String message;
        try {
            message = ((NormalUser) user).createPlaylist(commandInput.getPlaylistName(),
    ...
    public static ObjectNode addRemoveInPlaylist(final CommandInput commandInput) {
        ...
        String message;
        try {
            message = ((NormalUser) user).addRemoveInPlaylist(commandInput.getPlaylistId());
        } catch (UserOfflineException e) {
            message = user.getUsername() + " is offline.";
        }
    ...
    public static ObjectNode switchVisibility(final CommandInput commandInput) {
        ...
        String message;
        try {
            message = ((NormalUser) user).switchPlaylistVisibility(commandInput.getPlaylistId());
        } catch (UserOfflineException e) {
            message = user.getUsername() + " is offline.";
        }
    ...
    public static ObjectNode follow(final CommandInput commandInput) {
        ...
        String message;
        try {
            message = ((NormalUser) user).follow();
        } catch (UserOfflineException e) {
            message = user.getUsername() + " is offline.";
        }
     ...
     *
     * @param commandInput the command input
     * @return the object node containing the result of the command
     */
    ...
    /**
     * Prints information about the current page.
     *
     * @param commandInput the command input
     * @return information on the current page
     */
    public static ObjectNode printCurrentPage(final CommandInput commandInput) {
        ...
        String message;
        try {
            message = ((NormalUser) user).printCurrentPage();
        } catch (UserOfflineException e) {
